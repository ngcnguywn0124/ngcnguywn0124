...
**Frontend:** React, NextJS, TypeScript, Tailwind CSS, Bootstrap, HTML/CSS  
**Backend:** Java (Spring Boot), C# (.NET Core), NodeJS (ExpressJS)  
**Database:** PostgreSQL, MySQL, SQL Server, MongooDB  
...
|---------|-------------|-------|
| [RAG with LangChain](https://github.com/Sad3esuy/RAGvLangChain_demov1) | Document Q&A with vector search | React, Python, ChromaDB |
| [Portfolio](https://sad3esuy.github.io/sad3esuyy_portfolio/) | Personal portfolio website | HTML, CSS, JS, Bootstrap |
